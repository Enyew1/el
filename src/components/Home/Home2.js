        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I love programming more specifically website development and I
              ...
              with <b className="purple">Django, a python framework</b> and
              <i>
                <b className="purple"> a JavaScript library </b>
              </i>
              &nbsp; like
              <i>
